...
import bocai.com.yanghuajien.presenter.intelligentPlanting.PlantDataPresenter;
import bocai.com.yanghuajien.presenter.intelligentPlanting.PlantingDataContract;
import bocai.com.yanghuajien.ui.plantingDiary.PlantingDiaryActivity;
        ...
        LongTooth.request(plantModel.getLTID(), "longtooth", LongToothTunnel.LT_ARGUMENTS, request.getBytes(),
                0, request.getBytes().length, null,new  LongToothServiceResponseHandler(){
                    ...
                    public void handleServiceResponse(LongToothTunnel ltt, String ltid_str,
                        ...
                        if (mPresenter==null||
                                mPlantBean==null||
                                TextUtils.isEmpty(mPlantBean.getMac())){
                            return;
                        }
                        switch (code) {
                            case 501:
