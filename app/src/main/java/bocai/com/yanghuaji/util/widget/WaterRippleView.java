...
public class WaterRippleView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int waveColor = typedArray.getColor(R.styleable.WaterRippleView_waterRippleColor,
        ...
        mStrokePaint.setColor(ContextCompat.getColor(context, R.color.circle_stroke));
    }
    ...
    private void drawRipple(Canvas canvas) {
        for (int strokeWidth : mStrokeWidthArr) {
            ...
            canvas.drawCircle(mWidth / 2, mHeight / 2, mBitmap.getWidth() / 2 + strokeWidth / 2,
                    mPaint);
            canvas.drawCircle(mWidth / 2, mHeight / 2, mBitmap.getWidth() / 2 + strokeWidth,
                    mStrokePaint);
        }
        for (int i = 0; i < mStrokeWidthArr.length; i++) {
